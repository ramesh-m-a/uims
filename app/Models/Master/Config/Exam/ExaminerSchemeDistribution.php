...
class ExaminerSchemeDistribution extends BaseMasterModel
{
    use SoftDeletes;

    protected $table = 'mas_examiner_scheme_distribution';
    ...
    {
        return $query->where('mas_examiner_scheme_distribution_status_id', 1);
    }
    ...
    public function streams()
    {
        return $this->belongsToMany(
            ...
            ->wherePivot('mas_examiner_scheme_distribution_stream_status_id', 1)
