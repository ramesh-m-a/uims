...
class CollegeControllerold extends Controller
{
    /**
    ...
    {
        $colleges = College::orderBy('mas_college_name')->get(); // adjust column
        return view('master.college.index', compact('colleges'));
    }
    ...
    public function storee(Request $request)
    {
        ...
        return redirect()->route('master.college.index')->with('success', 'College created.');
    }
     ...
     */
    public function updatee(Request $request, College $college)
    {
        $validated = $request->validate([
            'mas_college_name' => 'required|string|max:255',
            // other fields...
        ...
        return redirect()->route('master.college.index')->with('success', 'College updated.');
    }

    /**
     * Remove the specified college from storage.
     */
    public function destroyy(College $college)
    {
        $college->delete();
        return redirect()->route('master.college.index')->with('success', 'College deleted.');
    }
    ...
    {
        $colleges = College::orderBy('id')->get(); // adapt ordering/filtering if needed

        // return a small view that contains only the <tr> rows
    ...
    public function storeq(Request $request)
    {
        ...
        try {
            \App\Models\Master\Config\Academic\College::create($validated);
    ...
    public function updateq(Request $request, College $college)
    {
        $validated = $request->validate([
            'mas_college_name' => 'required|string|max:255',
            'mas_college_code' => 'nullable|string|max:50',
    ...
    public function destroyq(College $college)
    {
        try {
            $college->delete();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $college = \App\Models\Master\Config\Academic\College::create($validator->validated());
    ...
    public function datatable(Request $request)
    {
        ...
        $query = \App\Models\Master\Config\Academic\College::query();
        ...
        $totalData    = \App\Models\Master\Config\Academic\College::count();
