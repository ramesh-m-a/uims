...
namespace App\Livewire\Admin\Principals;
...
class PrincipalsListTable extends MasterTableBase
{
    /* ==========================
    | MODEL
    ========================== */
    ...
    protected function baseQuery(): Builder
    {
        $query = parent::baseQuery()
            ->with([
                ...
                'basicDetails:id,basic_details_user_id,basic_details_department_id,basic_details_is_administrative_id',
            ...
            // Only principals
            ->whereHas('basicDetails', function ($q) {
                $q->where('basic_details_is_administrative_id', 3);
            });
...
HTML);
        ...
        return view('livewire.admin.principals.principals-list-table', [
            'rows' => $rows,
