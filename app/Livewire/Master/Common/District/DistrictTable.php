...
namespace App\Livewire\Master\Common\District;

use App\Livewire\Master\Concerns\MasterFormBase;
use App\Livewire\Master\MasterTableBase;
use App\Models\Master\Common\District;

class DistrictTable extends MasterTableBase
{
    use MasterFormBase;
    ...
    {
        return [
            'form.mas_district_name'       => 'required|string|max:255',
            'form.mas_district_status_id'  => 'required|in:1,2',
        ];
    }
    ...
    {
        return [
            'form.mas_district_name'       => 'District Name',
            'form.mas_district_status_id'  => 'Status',
        ];
    }
    ...
    public function render()
    {
        ...
        return view('livewire.master.common.district.district-table', [
            // data
            'districts' => $rows,
    ...
    public function deleteConfirmed(): void
    {
        ...
        District::findOrFail($this->deleteId)->delete();

        $this->js(
            "Alpine.store('toast').push('success','District deleted successfully !')"
        );
    ...
    public function deleteSelected(): void
    {
        ...
        $this->js(
            "Alpine.store('toast').push('success','Selected District deleted successfully !')"
        );
    ...
    public function restoreRow(int $id): void
    {
        ...
        $this->js(
            "Alpine.store('toast').push('success','District restored successfully !')"
        );
