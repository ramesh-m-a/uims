...
class BankTable extends MasterTableBase
{
    ...
    public function render()
    {
        ...
        return view('livewire.master.common.bank.bank-table', [
            'banks'          => $rows,
