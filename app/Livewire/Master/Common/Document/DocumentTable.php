...
namespace App\Livewire\Master\Common\Document;
...
class DocumentTable extends MasterTableBase
{
    use MasterFormBase;
    ...
    {
        return [
            'form.mas_document_name'       => 'required|string|max:255',
            'form.mas_document_status_id'  => 'required|in:1,2',
        ];
    }
    ...
    {
        return [
            'form.mas_document_name'       => 'Document Name',
            'form.mas_document_status_id'  => 'Status',
        ];
    }
    ...
    public function render()
    {
        ...
        return view('livewire.master.common.document.document-table', [
            // data
            'documents' => $rows,
    ...
    public function deleteConfirmed(): void
    {
        ...
        $this->js(
            "Alpine.store('toast').push('success','Document deleted successfully !')"
        );
    ...
    public function deleteSelected(): void
    {
        ...
        $this->js(
            "Alpine.store('toast').push('success','Selected Document deleted successfully !')"
        );
    ...
    public function restoreRow(int $id): void
    {
        ...
        $this->js(
            "Alpine.store('toast').push('success','Document restored successfully !')"
        );
