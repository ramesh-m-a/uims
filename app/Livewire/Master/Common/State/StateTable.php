...
class StateTable extends MasterTableBase
{
    ...
    {
        return [
            'form.mas_state_name'       => 'required|string|max:255',
            'form.mas_state_status_id'  => 'required|in:1,2',
        ];
    }
    ...
    {
        return [
            'form.mas_state_name'       => 'State Name',
            'form.mas_state_status_id'  => 'Status',
        ];
    }
    ...
    public function render()
    {
        ...
        return view('livewire.master.common.state.state-table', [
            // data
            'states' => $rows,
    ...
    public function deleteConfirmed(): void
    {
        ...
        State::findOrFail($this->deleteId)->delete();

        $this->js(
            "Alpine.store('toast').push('success','State deleted successfully !')"
        );
    ...
    public function deleteSelected(): void
    {
        ...
        $this->js(
            "Alpine.store('toast').push('success','Selected State deleted successfully !')"
        );
    ...
    public function restoreRow(int $id): void
    {
        ...
        $this->js(
            "Alpine.store('toast').push('success','State restored successfully !')"
        );
