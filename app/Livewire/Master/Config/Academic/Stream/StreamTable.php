...
namespace App\Livewire\Master\Config\Academic\Stream;
...
class StreamTable extends MasterTableBase
{
    use MasterFormBase;
    ...
    {
        return 'master.config.academic.stream';
    }
    ...
    public function render()
    {
        ...
        return view('livewire.master.config.academic.stream.stream-table', [
            // data
            'streams' => $rows,
