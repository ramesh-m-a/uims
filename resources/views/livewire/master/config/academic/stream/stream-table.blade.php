<div class="space-y-4">
    ...
    {{-- =========================
     | PAGE TITLE ROW
     ========================= --}}
    <x-sub-header title="Stream" subtitle="View / Update">
        @if($canCreate)
            <button
                wire:click="create"
    ...
    <x-master.modal
        :show="$showModal"
        :title="$editingId ? 'Edit Stream' : 'Add Stream'"
        onSave="save"
        onCancel="cancelEdit"
    >
        <div class="modal-form">
            ...
            <x-master.form-row
                label="Name"
                name="form.mas_stream_name"
                required
            >
                <input
                    type="text"
                    class="form-control"
                    wire:model.defer="form.mas_stream_name"
            ...
            <x-master.form-row
                label="Code"
                name="form.mas_stream_short_code"
                required
            >
                <input
                    type="text"
                    class="form-control"
                    wire:model.defer="form.mas_stream_short_code"
            ...
            @if($editingId)
                <x-master.form-row
                    label="Status"
                    name="form.mas_stream_status_id"
                >
                    <select
                        class="form-select"
                        wire:model.defer="form.mas_stream_status_id"
                    >
