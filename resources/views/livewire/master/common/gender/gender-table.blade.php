<div class="space-y-4">
    ...
    {{-- =========================
     | PAGE TITLE ROW
     ========================= --}}
    <x-sub-header title="Gender" subtitle="View / Update">
@if($canCreate)
            <button
                wire:click="create"
    ...
    <x-master.modal
        :show="$showModal"
        :title="$editingId ? 'Edit Gender' : 'Add Gender'"
        onSave="save"
        onCancel="cancelEdit"
    >
        <div class="modal-form">
            ...
            <x-master.form-row
                label="Name"
                name="form.mas_gender_name"
                required
            >
                <input
                    type="text"
                    class="form-control"
                    wire:model.defer="form.mas_gender_name"
            ...
            @if($editingId)
                <x-master.form-row
                    label="Status"
                    name="form.mas_gender_status_id"
                >
                    <select
                        class="form-select"
                        wire:model.defer="form.mas_gender_status_id"
                    >
