<div class="space-y-4">
    ...
    <x-master.modal
        :show="$showModal"
        :title="$editingId ? 'Edit Taluk' : 'Add Taluk'"
        onSave="save"
        onCancel="cancelEdit"
    >
        <div class="modal-form">
            ...
            <x-master.form-row
                label="Name"
                name="form.mas_taluk_name"
                required
            >
                <input
                    type="text"
                    class="form-control"
                    wire:model.defer="form.mas_taluk_name"
            ...
            @if($editingId)
                <x-master.form-row
                    label="Status"
                    name="form.mas_taluk_status_id"
                >
                    <select
                        class="form-select"
                        wire:model.defer="form.mas_taluk_status_id"
                    >
