<div class="space-y-4">
    ...
    <x-master.modal
        :show="$showModal"
        :title="$editingId ? 'Edit Religion' : 'Add Religion'"
        onSave="save"
        onCancel="cancelEdit"
    >
        <div class="modal-form">
            ...
            <x-master.form-row
                label="Name"
                name="form.mas_religion_name"
                required
            >
                <input
                    type="text"
                    class="form-control"
                    wire:model.defer="form.mas_religion_name"
            ...
            @if($editingId)
                <x-master.form-row
                    label="Status"
                    name="form.mas_religion_status_id"
                >
                    <select
                        class="form-select"
                        wire:model.defer="form.mas_religion_status_id"
                    >
