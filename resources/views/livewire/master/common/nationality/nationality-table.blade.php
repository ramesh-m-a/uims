<div class="space-y-4">
    ...
    <x-master.modal
        :show="$showModal"
        :title="$editingId ? 'Edit Nationality' : 'Add Nationality'"
        onSave="save"
        onCancel="cancelEdit"
    >
        <div class="modal-form">
            ...
            <x-master.form-row
                label="Name"
                name="form.mas_nationality_name"
                required
            >
                <input
                    type="text"
                    class="form-control"
                    wire:model.defer="form.mas_nationality_name"
            ...
            @if($editingId)
                <x-master.form-row
                    label="Status"
                    name="form.mas_nationality_status_id"
                >
                    <select
                        class="form-select"
                        wire:model.defer="form.mas_nationality_status_id"
                    >
